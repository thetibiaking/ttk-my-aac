...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($resultado->status === 'pending') {
        ...
        echo '<button onclick="location.href=\'https://eternalglobal.online/?p=mpnotification&id=' . $collector_id . '&debug=' . ($debug ? 'true' : 'false') . '\'" type="button">Conferir Status do Pedido</button> <br>';
